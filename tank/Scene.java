	...
	private Cell genMapElement(int type,int col,int row){
		...
		switch(type){
			case Mapelements.ELEMENT_TYPE_WALL:
				element = new Cell(col*Mapelements.CS,row*Mapelements.CS,Mapelements.ELEMENT_TYPE_WALL);
				break;
				
			case Mapelements.ELEMENT_TYPE_STEEL:
				element = new Cell(col*Mapelements.CS,row*Mapelements.CS,Mapelements.ELEMENT_TYPE_STEEL);
				break;
				
			case Mapelements.ELEMENT_TYPE_BASE:
				element = new Cell(col*Mapelements.CS,row*Mapelements.CS,Mapelements.ELEMENT_TYPE_BASE);
				break;
				
			case Mapelements.ELEMENT_TYPE_EDGE:
				element = new Cell(col*Mapelements.CS,row*Mapelements.CS,Mapelements.ELEMENT_TYPE_EDGE);
				break;
				
			case Mapelements.ELEMENT_TYPE_WHITEFLAG:
				element = new Cell(col*Mapelements.CS,row*Mapelements.CS,Mapelements.ELEMENT_TYPE_WHITEFLAG);
				break;
				
			case Mapelements.ELEMENT_TYPE_LAKE:
				element = new Cell(col*Mapelements.CS,row*Mapelements.CS,Mapelements.ELEMENT_TYPE_LAKE);
				break;
		}
		return element;
	}
